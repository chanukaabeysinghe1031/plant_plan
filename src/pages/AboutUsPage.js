  ...
  return (
    ...
    >
      ...
      <p>
        ...
        sensors and data analytics. Mainly educated selctions about how to care
        for their plants will assits users ensure that they thrive and generate
      ...
      <p>
        ...
        independance enabling people to take chaege of their own food production
        and cut costs.
      </p>
      <p>
        ...
        multiple modes are planning to be implemented to support a wide range of
        devices aswell as providing additional features to increase usefullness
        for plant enthusiats.
      </p>
      <p>
        Therefore eventhough PlantPlan is a prototype it has enormous intentions
        for the future. Watch for updates as they will undoutably improve the
        app.
      </p>
      <h2>Our Services</h2>
      <h5>Live Monitoring</h5>
      <p>
        Users may keep a close eye on their plant's health and development using
        PlantPlan's Live monitoring tool. This enables them to see problems
        early on and take the required steps to protect the helth of their
        plants.
      </p>
      ...
      <p>
        ...
        and knowledgeable decisions regarding the health of their plants thanks
        to the PlantPlan.
      </p>
    </div>
  );
